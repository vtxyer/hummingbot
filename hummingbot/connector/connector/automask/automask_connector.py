...
from hummingbot.connector.connector.automask.automask_in_flight_order import AutomaskInFlightOrder
...
class AutomaskConnector(ConnectorBase):
    """
    ...
    def __init__(self,
                 automask_wallet_address: str,
                 automask_wallet_seeds: str,
    ...
    async def _create_order(self,
        ...
        api_params = {"base": base,
                      ...
                      "amount": str(amount),
                      "privateKey": self._automask_wallet_seeds,
                      # "maxPrice": str(price),
                      }
        ...
        try:
            ...
            self.logger().network(
                f"Error submitting {trade_type.name} order to automask for "
    ...
    def start_tracking_order(self,
        ...
        """
        self._in_flight_orders[order_id] = AutomaskInFlightOrder(
    ...
    @property
    def in_flight_orders(self) -> Dict[str, AutomaskInFlightOrder]:
